...
import com.commerce.app.security.SecurityUtils;
import com.commerce.app.service.ShoppingCartService;
import com.commerce.app.web.rest.vm.PaymentRedirectVM;
import com.commerce.app.web.rest.vm.PaymentRequestVM;
import com.commerce.app.web.rest.vm.PaymentResponseVM;
...
public class CheckoutResource {
    ...
    @Value("${application.adyen.merchant-account}")
    private String merchantAccount;
    @Value("${application.adyen.origin-key}")
    private String originKey;

    private final Checkout checkout;
    private final ShoppingCartService shoppingCartService;

    public CheckoutResource(final ShoppingCartService shoppingCartService, @Value("${application.adyen.api-key}") String apiKey) {
    ...
    private Amount getAmountFromCart() {
        ...
        Optional<ShoppingCart> activeCart = shoppingCartService.findActiveCartByUser(user);

        Amount amount = new Amount();
        amount.setCurrency("EUR");
        amount.setValue(toMinorUnit(activeCart.get().getTotalPrice()));
        return amount;
    }
