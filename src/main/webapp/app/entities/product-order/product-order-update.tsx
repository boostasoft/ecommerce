  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="commerceApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
                ...
                >
                  {shoppingCarts
                    ? shoppingCarts.map(otherEntity => (
                        <option value={otherEntity.customerDetails?.user?.login} key={otherEntity.id}>
                          {otherEntity.customerDetails?.user?.login}
                        </option>
                      ))
                    : null}
                </AvInput>
